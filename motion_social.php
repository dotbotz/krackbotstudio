   ...
   <div class="container">
     <div class="row">
      ...
      <div class="products mt-5">
        <ul>
          <li>
               <a href="motion_illustrate.php"> 
            <div class="product-container">
              <img src="images/s1.png" class="img-fluid" alt="">
              <h5>Illustrations <br/> </h5>
...
-->
  ...
  <ul class="nav nav-tabs nav-justified" role="tablist">
    <li class="nav-item">
      <a class="nav-link active" data-toggle="tab" href="#html">HTML5</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" data-toggle="tab" href="#wordpress">Wordpress</a>
    </li>
    <li class="nav-item">
  ...
  <div class="tab-content">
    ...
    <li class="nav-item">
      <a class="nav-link" href="motion_social.php">
