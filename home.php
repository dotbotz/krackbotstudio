...
<!-- header include end-->
  ...
  <div class="row">
        ...
        <div class="col-sm-12 css-typing pt-4">
            <h1 class="mb-0"><b> Oh hi there! </b></h1>
            <h1><b>I’m Krackbot &amp; welcome to my site!</b></h1>
          <h2 class="my-3"> Let me walk you around to know what’s in store for you.</h2>
           <h2 class="mb-4"> First, let’s get to know you.</h2>
<!--
            <h1 class="ml11">
