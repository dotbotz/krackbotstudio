...
<!-- banner section start-->
 ...
 <section>
  ...
  <ul class="nav nav-tabs nav-justified" role="tablist">
    <li class="nav-item">
      <a class="nav-link active" data-toggle="tab" href="#social">Social Media Images</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" data-toggle="tab" href="#promo">Promo Graphics</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" data-toggle="tab" href="#email">Email Signature</a>
    </li>
  </ul>
