...
<!-- banner section start-->
 ...
 <section>
  ...
  <ul class="nav nav-tabs nav-justified" role="tablist">
    <li class="nav-item">
      <a class="nav-link active" data-toggle="tab" href="#logo">illustrated Motion Graphics</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" data-toggle="tab" href="#business">Basic style Motion Graphics</a>
    </li>
