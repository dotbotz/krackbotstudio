 ...
 <section>
  <div class="container-fluid">
   <div class="container">
     <div class="row">
        ...
        <div class="col-sm-12">
          ...
          <div class="row">
           <div class="col-sm-3 col-4">
            ...
            <div class="col-sm-12 bg-light pt-4 pb-1 br15">
              <img src="images/location.png" class="img-fluid col-sm-8 offset-sm-2 col-12 offset-0 mb-4" alt="krackbot" title="services">
                <h6><b> Banglore </b></h6>
         ...
         <div class="col-sm-6">
          <div class="col-sm-6 offset-sm-3 bg-light py-3 mt-5 contactform">
              <h5 class="pb-1"><b>Get in touch with us</b></h5>
   <form method="post" action="#">
    ...
    <div class="form-group">
       <textarea class="form-control" rows="4" placeholder="Message" name="message" id="message" style="resize:none"></textarea>
     </div>
        <div class="form-group">
       <input type="text" class="form-control" placeholder="Website (if any)" name="web" id="web">
     </div>
       <button class="btn btn-secondary col-sm-12 mt-3" type="submit"><b>Submit</b></button>
   </form>  
          </div>
         </div>
